...
namespace Cbddo.eYazisma.Tipler
{
    ...
    public class Paket : IDisposable
    {
        ...
        public void PaketOzetiOlustur()
        {
            ...
            byte[] ozetUstVeri = Araclar.OzetHesapla(UstveriAl(), VarsayilanOzetModu);
            byte[] ozetUstVeriSha512 = Araclar.OzetHesapla(UstveriAl(), OzetModu.SHA512);
            ...
            byte[] ozetUstYazi = Araclar.OzetHesapla(UstYaziAl(), VarsayilanOzetModu);
            byte[] ozetUstYaziSha512 = Araclar.OzetHesapla(UstYaziAl(), OzetModu.SHA512);
            ...
            if (ParafOzetiVarMi())
            {
                ...
                byte[] ozetParafOzeti = Araclar.OzetHesapla(ParafOzetiAl(), VarsayilanOzetModu);
                byte[] ozetParafOzetiSha512 = Araclar.OzetHesapla(ParafOzetiAl(), OzetModu.SHA512);
            ...
            if (ParafImzaVarMi())
            {
                ...
                byte[] ozetParafImza = Araclar.OzetHesapla(ParafImzaAl(), VarsayilanOzetModu);
                byte[] ozetParafImzaSha512 = Araclar.OzetHesapla(ParafImzaAl(), OzetModu.SHA512);
        ...
        public void ParafOzetiOlustur()
        {
            ...
            var partUriUstveri = PackUriHelper.CreatePartUri(new Uri(Araclar.URI_USTVERI, UriKind.Relative));
            byte[] ozet = Araclar.OzetHesapla(UstveriAl(), VarsayilanOzetModu);
            byte[] ozetSha512 = Araclar.OzetHesapla(UstveriAl(), OzetModu.SHA512);
            ParafOzeti.Ekle(VarsayilanOzetModu, ozet, ozetSha512, partUriUstveri);
        ...
        public void NihaiOzetOlustur()
        {
            ...
            byte[] ozetPaketOzeti = Araclar.OzetHesapla(PaketOzetiAl(), VarsayilanOzetModu);
            byte[] ozetPaketOzetiSha512 = Araclar.OzetHesapla(PaketOzetiAl(), OzetModu.SHA512);
            ...
            byte[] ozetImza = Araclar.OzetHesapla(ImzaAl(), VarsayilanOzetModu);
            byte[] ozetImzaSha512 = Araclar.OzetHesapla(ImzaAl(), OzetModu.SHA512);
            ...
            byte[] ozetNihaiUstveri = Araclar.OzetHesapla(NihaiUstveriAl(), VarsayilanOzetModu);
            byte[] ozetNihaiUstveriSha512 = Araclar.OzetHesapla(NihaiUstveriAl(), OzetModu.SHA512);
        ...
        {
            if (_package.PartExists(new Uri(Araclar.URI_NIHAIUSTVERI, UriKind.Relative)))
            {
                return _package.GetPart(new Uri(Araclar.URI_NIHAIUSTVERI, UriKind.Relative)).GetStream();
            }
            return null;
        }
        ...
        public void ImzaEkle(Byte[] imza)
        {
            ...
            part02.GetStream().Write(imza, 0, imza.Length);
        ...
        {
            if (_package.PartExists(new Uri(Araclar.URI_PARAFIMZA, UriKind.Relative)))
            {
                return _package.GetPart(new Uri(Araclar.URI_PARAFIMZA, UriKind.Relative)).GetStream();
            }
            else return null;
        }
        ...
        public Stream ParafOzetiAl()
        {
            ...
            {
                return _package.GetPart(new Uri(Araclar.URI_PARAFOZETI, UriKind.Relative)).GetStream();
            }
            return null;
