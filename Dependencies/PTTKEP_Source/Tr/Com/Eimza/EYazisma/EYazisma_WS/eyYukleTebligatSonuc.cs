...
namespace Tr.Com.Eimza.EYazisma.EYazisma_WS
{
	...
	public class eyYukleTebligatSonuc : INotifyPropertyChanged
	{
		...
		[XmlElement("DonusBarkod", Order = 2)]
		public eyDonusBarkod[] DonusBarkod
		{
			get
			{
				return donusBarkodField;
			}
			set
			{
				donusBarkodField = value;
				RaisePropertyChanged("DonusBarkod");
			}
		}
