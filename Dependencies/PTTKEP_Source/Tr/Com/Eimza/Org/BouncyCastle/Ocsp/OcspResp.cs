...
namespace Tr.Com.Eimza.Org.BouncyCastle.Ocsp
{
	internal class OcspResp
	{
		...
		public int Status
		{
			get
			{
				return resp.ResponseStatus.Value.IntValue;
			}
		}

		public OcspResponse Resp
		{
			get
			{
				return resp;
		...
		public object GetResponseObject()
		{
			...
			if (responseBytes.ResponseType.Equals(OcspObjectIdentifiers.PkixOcspBasic))
			{
				...
				{
					throw new OcspException("problem decoding object: " + ((ex != null) ? ex.ToString() : null), ex);
				}
			}
