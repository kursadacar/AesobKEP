...
{
	internal class OcspReq : X509ExtensionBase
	{
		...
		public int Version
		{
			get
			{
				return req.TbsRequest.Version.Value.IntValue + 1;
			}
		}
		...
		public GeneralName RequestorName
		{
			get
			{
				return GeneralName.GetInstance(req.TbsRequest.RequestorName);
			}
		}
		...
		public X509Extensions RequestExtensions
		{
			get
			{
				return X509Extensions.GetInstance(req.TbsRequest.RequestExtensions);
			}
		}
		...
		public bool IsSigned
		{
			get
			{
				return req.OptionalSignature != null;
			}
		}
