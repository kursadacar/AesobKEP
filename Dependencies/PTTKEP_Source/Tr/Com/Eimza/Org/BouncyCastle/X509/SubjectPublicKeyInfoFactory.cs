...
{
	internal sealed class SubjectPublicKeyInfoFactory
	{
		...
		public static SubjectPublicKeyInfo CreateSubjectPublicKeyInfo(AsymmetricKeyParameter key)
		{
			...
			if (key is ECPublicKeyParameters)
			{
				...
				return new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.IdECPublicKey, x962Parameters.ToAsn1Object()), asn1OctetString.GetOctets());
			}
