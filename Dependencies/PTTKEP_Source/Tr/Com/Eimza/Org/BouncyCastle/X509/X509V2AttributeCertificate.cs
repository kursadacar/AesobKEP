...
{
	internal class X509V2AttributeCertificate : X509ExtensionBase, IX509AttributeCertificate, IX509Extension
	{
		...
		public virtual int Version
		{
			get
			{
				return cert.ACInfo.Version.Value.IntValue + 1;
			}
		}
		...
		public virtual BigInteger SerialNumber
		{
			get
			{
				return cert.ACInfo.SerialNumber.Value;
			}
		}
