...
{
	internal class X509CertStoreSelector : IX509Selector, ICloneable
	{
		...
		public virtual bool Match(object obj)
		{
			...
			if (issuer != null && !issuer.Equivalent(x509Certificate.IssuerDN, true))
			{
				return false;
			}
			if (keyUsage != null)
			...
			if (subject != null && !subject.Equivalent(x509Certificate.SubjectDN, true))
			{
				return false;
			}
			...
			if (subjectPublicKeyAlgID != null && !subjectPublicKeyAlgID.Equals(GetSubjectPublicKey(x509Certificate).AlgorithmID.ObjectID))
			{
				return false;
			}
			return true;
