...
{
	internal class SignaturePacket : ContainedPacket
	{
		private int version;
		...
		internal SignaturePacket(BcpgInputStream bcpgIn)
		{
			...
			case PublicKeyAlgorithmTag.RsaSign:
			{
				...
				signature = new MPInteger[1] { mPInteger };
				return;
			}
			case PublicKeyAlgorithmTag.Dsa:
			{
				...
				signature = new MPInteger[2] { mPInteger5, mPInteger6 };
				return;
			}
			...
			case PublicKeyAlgorithmTag.ElGamalGeneral:
			{
				...
				signature = new MPInteger[3] { mPInteger2, mPInteger3, mPInteger4 };
				return;
			}
			}
		...
		public byte[] GetSignatureBytes()
		{
			...
			foreach (MPInteger bcpgObject in array)
			{
				...
				{
					throw new Exception("internal error: " + ((ex != null) ? ex.ToString() : null));
				}
			}
