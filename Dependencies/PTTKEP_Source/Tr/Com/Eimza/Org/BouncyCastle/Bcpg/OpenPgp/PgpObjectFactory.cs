...
{
	internal class PgpObjectFactory
	{
		...
		public PgpObject NextPgpObject()
		{
			...
			case PacketTag.Signature:
			{
				...
				while (bcpgIn.NextPacketTag() == PacketTag.Signature)
				{
					...
					{
						throw new IOException("can't create signature object: " + ((ex3 != null) ? ex3.ToString() : null));
					}
				}
			...
			case PacketTag.SecretKey:
				...
				{
					throw new IOException("can't create secret key object: " + ((ex2 != null) ? ex2.ToString() : null));
				}
			...
			case PacketTag.OnePassSignature:
			{
				...
				while (bcpgIn.NextPacketTag() == PacketTag.OnePassSignature)
				{
					...
					{
						throw new IOException("can't create one pass signature object: " + ((ex != null) ? ex.ToString() : null));
					}
				}
