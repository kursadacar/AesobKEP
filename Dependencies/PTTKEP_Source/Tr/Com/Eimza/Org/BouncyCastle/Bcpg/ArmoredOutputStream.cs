...
{
	internal class ArmoredOutputStream : BaseOutputStream
	{
		...
		{
			Version obj = Assembly.GetExecutingAssembly().GetName().Version;
			version = "BCPG C# v" + (((object)obj != null) ? obj.ToString() : null);
		}
	}
}
