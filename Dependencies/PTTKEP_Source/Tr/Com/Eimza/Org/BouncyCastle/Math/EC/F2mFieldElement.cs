...
{
	internal class F2mFieldElement : ECFieldElement
	{
		...
		{
			LongArray longArray = x;
			if (longArray.IsOne() || longArray.IsZero())
			{
				return this;
			}
			LongArray longArray2 = longArray.ModSquareN(m - 1, m, ks);
			return new F2mFieldElement(m, ks, longArray2);
		}
