...
namespace Tr.Com.Eimza.Org.BouncyCastle.Math
{
	[Serializable]
	internal class BigInteger
	{
		...
		public BigInteger ModPow(BigInteger e, BigInteger m)
		{
			...
			if (!e.Equals(One))
			{
				bigInteger = ((((uint)m.magnitude[m.magnitude.Length - 1] & (true ? 1u : 0u)) != 0) ? ModPowMonty(bigInteger, e, m, true) : ModPowBarrett(bigInteger, e, m));
			}
			if (num)
			{
