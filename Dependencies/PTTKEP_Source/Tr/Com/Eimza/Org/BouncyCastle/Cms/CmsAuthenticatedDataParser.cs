...
{
	internal class CmsAuthenticatedDataParser : CmsContentInfoParser
	{
		...
		private Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable authAttrs;

		private Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable unauthAttrs;
		...
		public Asn1Object MacAlgParams
		{
			get
			{
				Asn1Encodable parameters = macAlg.Parameters;
				if (parameters != null)
				{
		...
		public Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable GetAuthAttrs()
		{
			if (authAttrs == null && authAttrNotRead)
			{
				...
				if (asn1SetParser != null)
				{
					...
					authAttrs = new Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable(new DerSet(asn1EncodableVector));
				}
			}
			return authAttrs;
		}
		...
		public Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable GetUnauthAttrs()
		{
			if (unauthAttrs == null && unauthAttrNotRead)
			{
				...
				if (asn1SetParser != null)
				{
					...
					unauthAttrs = new Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable(new DerSet(asn1EncodableVector));
				}
			}
			return unauthAttrs;
		}
