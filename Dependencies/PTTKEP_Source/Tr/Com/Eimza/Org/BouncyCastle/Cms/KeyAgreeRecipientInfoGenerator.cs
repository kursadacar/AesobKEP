...
using Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.Ecc;
...
namespace Tr.Com.Eimza.Org.BouncyCastle.Cms
{
	internal class KeyAgreeRecipientInfoGenerator : RecipientInfoGenerator
	{
		...
		public RecipientInfo Generate(KeyParameter contentEncryptionKey, SecureRandom random)
		{
			...
			{
				throw new InvalidKeyException("cannot extract originator public key: " + ((ex != null) ? ex.ToString() : null));
			}
			...
			if (keyAgreementOID.Id.Equals(CmsEnvelopedGenerator.ECMqvSha1Kdf))
			{
				...
				{
					throw new InvalidKeyException("cannot extract MQV ephemeral public key: " + ((ex2 != null) ? ex2.ToString() : null));
				}
				catch (SecurityUtilityException ex3)
				{
					throw new InvalidKeyException("cannot determine MQV ephemeral key pair parameters from public key: " + ((ex3 != null) ? ex3.ToString() : null));
				}
			}
