...
{
	internal class CmsEnvelopedDataParser : CmsContentInfoParser
	{
		...
		private Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable _unprotectedAttributes;
		...
		public Asn1Object EncryptionAlgParams
		{
			get
			{
				Asn1Encodable parameters = _encAlg.Parameters;
				if (parameters != null)
				{
		...
		public Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable GetUnprotectedAttributes()
		{
			if (_unprotectedAttributes == null && _attrNotRead)
			{
				...
				if (unprotectedAttrs != null)
				{
					...
					_unprotectedAttributes = new Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable(new DerSet(asn1EncodableVector));
				}
			}
