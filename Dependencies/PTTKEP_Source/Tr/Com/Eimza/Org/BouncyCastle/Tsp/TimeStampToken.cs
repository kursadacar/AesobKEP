...
namespace Tr.Com.Eimza.Org.BouncyCastle.Tsp
{
    internal class TimeStampToken
	{
		...
		public Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable SignedAttributes
		{
			get
			{
				return tsaSignerInfo.SignedAttributes;
			}
		}
		...
		public Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.AttributeTable UnsignedAttributes
		{
			get
			{
				return tsaSignerInfo.UnsignedAttributes;
			}
		}

		public TimeStampToken(Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.ContentInfo contentInfo)
		...
		public TimeStampToken(CmsSignedData signedData)
		{
			...
			try
			{
				...
				Tr.Com.Eimza.Org.BouncyCastle.Asn1.Cms.Attribute attribute = tsaSignerInfo.SignedAttributes[PkcsObjectIdentifiers.IdAASigningCertificate];
				if (attribute != null)
				{
		...
		public void Validate(X509Certificate cert)
		{
			...
			catch (CmsException ex)
			{
				...
				throw new TspException("CMS exception: " + ((ex != null) ? ex.ToString() : null), ex);
			}
			catch (CertificateEncodingException ex2)
			{
				throw new TspException("problem processing certificate: " + ((ex2 != null) ? ex2.ToString() : null), ex2);
			}
