...
namespace Tr.Com.Eimza.Org.BouncyCastle.Crypto.Encodings
{
	internal class Pkcs1Encoding : IAsymmetricBlockCipher
	{
		public const string StrictLengthEnabledProperty = "Tr.Com.Eimza.Org.BouncyCastle.Pkcs1.Strict";
		...
		{
			string environmentVariable = Platform.GetEnvironmentVariable("Tr.Com.Eimza.Org.BouncyCastle.Pkcs1.Strict");
