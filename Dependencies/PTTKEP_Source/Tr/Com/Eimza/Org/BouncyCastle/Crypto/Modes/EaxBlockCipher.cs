...
namespace Tr.Com.Eimza.Org.BouncyCastle.Crypto.Modes
{
	internal class EaxBlockCipher : IAeadBlockCipher
	{
		...
		public virtual string AlgorithmName
		{
			get
			{
				return cipher.GetUnderlyingCipher().AlgorithmName + "/EAX";
			}
		}
		...
		public virtual int DoFinal(byte[] outBytes, int outOff)
		{
			...
			if (forEncryption)
			{
				...
				cipher.ProcessBlock(bufBlock, blockSize, array, blockSize);
