...
{
	internal class Iso9796d2Signer : ISignerWithRecovery, ISigner
	{
		...
		public string AlgorithmName
		{
			get
			{
				return digest.AlgorithmName + "withISO9796-2S1";
			}
		}
		...
		public virtual byte[] GenerateSignature()
		{
			...
			byte[] array = cipher.ProcessBlock(block, 0, block.Length);
			ClearBlock(mBuf);
			ClearBlock(block);
