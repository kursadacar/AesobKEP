	...
	internal abstract class TlsProtocol
	{
		...
		private void ProcessHandshake()
		{
			...
			do
			{
				...
				{
					int num2 = 20;
					if (b == 20 && mExpectedVerifyData == null)
					{
		...
		protected virtual short ProcessMaxFragmentLengthExtension(IDictionary clientExtensions, IDictionary serverExtensions, byte alertDescription)
		{
			...
			if (maxFragmentLengthExtension >= 0 && !mResumedSession && maxFragmentLengthExtension != TlsExtensionsUtilities.GetMaxFragmentLengthExtension(clientExtensions))
			{
