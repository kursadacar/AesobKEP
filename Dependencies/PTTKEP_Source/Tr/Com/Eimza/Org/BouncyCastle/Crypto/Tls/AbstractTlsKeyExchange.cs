...
{
	internal abstract class AbstractTlsKeyExchange : TlsKeyExchange
	{
		...
		public virtual void Init(TlsContext context)
		{
			...
			{
				throw new InvalidOperationException("supported_signature_algorithms not allowed for " + ((clientVersion != null) ? clientVersion.ToString() : null));
			}
		}
		...
		{
			IList mSupportedSignatureAlgorithm = mSupportedSignatureAlgorithms;
		}
