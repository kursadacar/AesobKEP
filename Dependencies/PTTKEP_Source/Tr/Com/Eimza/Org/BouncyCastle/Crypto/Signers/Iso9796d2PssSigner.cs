...
{
	internal class Iso9796d2PssSigner : ISignerWithRecovery, ISigner
	{
		...
		public string AlgorithmName
		{
			get
			{
				return digest.AlgorithmName + "withISO9796-2S2";
			}
		}
		...
		public byte[] GenerateSignature()
		{
			...
			block[0] &= 127;
			byte[] array6 = cipher.ProcessBlock(block, 0, block.Length);
			ClearBlock(mBuf);
			ClearBlock(block);
			messageLength = 0;
			currentSignature = array6;
			return currentSignature;
		}
