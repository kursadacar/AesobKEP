	...
	internal sealed class SecNamedCurves
	{
		...
		internal class Sect113r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("04009D73616F35F4AB1407D73562C10F00A52830277958EE84D1315ED31886"));
		...
		internal class Sect113r2Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				BigInteger bigInteger2 = BigInteger.ValueOf(2L);
				F2mCurve f2mCurve = new F2mCurve(113, 9, a, b, bigInteger, bigInteger2);
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0401A57A6A7B26CA5EF52FCDB816479700B3ADC94ED1FE674C06E695BABA1D"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect131r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect131r2Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				BigInteger bigInteger2 = BigInteger.ValueOf(2L);
				F2mCurve f2mCurve = new F2mCurve(131, 2, 3, 8, a, b, bigInteger, bigInteger2);
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect163k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect163r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("040369979697AB43897789566789567F787A7876A65400435EDB42EFAFB2989D51FEFCE3C80988F41FF883"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect163r2Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0403F0EBA16286A2D57EA0991168D4994637E8343E3600D51FBC6C71A0094FA2CDD545B11C5C0C797324F1"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect193r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0401F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E10025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect193r2Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				BigInteger bigInteger2 = BigInteger.ValueOf(2L);
				F2mCurve f2mCurve = new F2mCurve(193, 15, a, b, bigInteger, bigInteger2);
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0400D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect233k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect233r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0400FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B01006A08A41903350678E58528BEBF8A0BEFF867A7CA36716F7E01F81052"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect239k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect283k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect283r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("0405F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B1205303676854FE24141CB98FE6D4B20D02B4516FF702350EDDB0826779C813F0DF45BE8112F4"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect409k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("040060F05F658F49C1AD3AB1890F7184210EFD0987E307C84C27ACCFB8F9F67CC2C460189EB5AAAA62EE222EB1B35540CFE902374601E369050B7C4E42ACBA1DACBF04299C3460782F918EA427E6325165E9EA10E3DA5F6C42E9C55215AA9CA27A5863EC48D8E0286B"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect409r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode("04015D4860D088DDB3496B0C6064756260441CDE4AF1771D4DB01FFE5B34E59703DC255A868A1180515603AEAB60794E54BB7996A70061B1CFAB6BE5F32BBFA78324ED106A7636B9C5A7BD198D0158AA4F5488D08F38514F1FDF4B4F40D2181B3681C364BA0273C706"));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect571k1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode(""));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
		...
		internal class Sect571r1Holder : X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				...
				ECPoint g = f2mCurve.DecodePoint(Hex.Decode(""));
				return new X9ECParameters(f2mCurve, g, bigInteger, bigInteger2, seed);
			}
		}
