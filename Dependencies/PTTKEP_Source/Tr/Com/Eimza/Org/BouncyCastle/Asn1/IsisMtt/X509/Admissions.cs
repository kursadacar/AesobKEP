...
{
	internal class Admissions : Asn1Encodable
	{
		...
		private Admissions(Asn1Sequence seq)
		{
			...
			if (asn1Encodable is Asn1TaggedObject)
			{
				...
				{
				case 0:
					admissionAuthority = GeneralName.GetInstance((Asn1TaggedObject)asn1Encodable, true);
					break;
				case 1:
			...
			if (asn1Encodable is Asn1TaggedObject)
			{
				if (((Asn1TaggedObject)asn1Encodable).TagNo != 1)
				{
					throw new ArgumentException("Bad tag number: " + ((Asn1TaggedObject)asn1Encodable).TagNo);
				}
				namingAuthority = NamingAuthority.GetInstance((Asn1TaggedObject)asn1Encodable, true);
