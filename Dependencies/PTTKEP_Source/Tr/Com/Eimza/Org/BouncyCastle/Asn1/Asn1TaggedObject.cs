...
{
	internal abstract class Asn1TaggedObject : Asn1Object, Asn1TaggedObjectParser, IAsn1Convertible
	{
		internal int tagNo;
		...
		{
			string text = tagNo.ToString();
			Asn1Encodable asn1Encodable = obj;
			return "[" + text + "]" + ((asn1Encodable != null) ? asn1Encodable.ToString() : null);
		}
	}
}
