...
namespace Tr.Com.Eimza.Org.BouncyCastle.Asn1.Pkcs
{
	internal abstract class PkcsObjectIdentifiers
	{
		...
		public static readonly DerObjectIdentifier IdAAEtsArchiveTimestampV2 = new DerObjectIdentifier("1.2.840.113549.1.9.16.2.48");
		...
		public static string GetNameFromOID(DerObjectIdentifier searchOID)
		{
			FieldInfo[] fields = typeof(PkcsObjectIdentifiers).GetFields();
			foreach (FieldInfo fieldInfo in fields)
			{
				if ((object)fieldInfo.FieldType == typeof(DerObjectIdentifier) && ((DerObjectIdentifier)fieldInfo.GetValue(typeof(PkcsObjectIdentifiers))).Id.Equals(searchOID.Id))
				{
