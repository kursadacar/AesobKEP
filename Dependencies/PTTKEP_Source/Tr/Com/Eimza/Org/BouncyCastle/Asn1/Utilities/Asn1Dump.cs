...
{
	internal sealed class Asn1Dump
	{
		...
		private static void AsString(string indent, bool verbose, Asn1Object obj, StringBuilder buf)
		{
			...
			{
				string[] obj2 = new string[5] { indent, "Integer(", null, null, null };
				BigInteger value = ((DerInteger)obj).Value;
				obj2[2] = ((value != null) ? value.ToString() : null);
				obj2[3] = ")";
				obj2[4] = NewLine;
				buf.Append(string.Concat(obj2));
			}
			...
			else if (obj is DerEnumerated)
			{
				...
				string[] obj3 = new string[5] { indent, "DER Enumerated(", null, null, null };
				BigInteger value2 = derEnumerated.Value;
				obj3[2] = ((value2 != null) ? value2.ToString() : null);
				obj3[3] = ")";
				obj3[4] = NewLine;
				buf.Append(string.Concat(obj3));
			}
		...
		public static string DumpAsString(object obj)
		{
			...
			{
				StringBuilder stringBuilder = new StringBuilder();
				AsString("", false, ((Asn1Encodable)obj).ToAsn1Object(), stringBuilder);
				return stringBuilder.ToString();
			}
