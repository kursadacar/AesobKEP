...
{
	internal class AuthenticatedDataParser
	{
		...
		public OriginatorInfo GetOriginatorInfo()
		{
			...
			{
				Asn1SequenceParser obj = (Asn1SequenceParser)((Asn1TaggedObjectParser)nextObject).GetObjectParser(16, false);
				nextObject = null;
		...
		public AlgorithmIdentifier GetDigestAlgorithm()
		{
			...
			{
				AlgorithmIdentifier instance = AlgorithmIdentifier.GetInstance((Asn1TaggedObject)nextObject.ToAsn1Object(), false);
				nextObject = null;
				return instance;
			}
			return null;
