...
{
	internal class CertificatePair : Asn1Encodable
	{
		...
		private CertificatePair(Asn1Sequence seq)
		{
			...
			foreach (object item in seq)
			{
				...
				if (instance.TagNo == 0)
				{
					forward = X509CertificateStructure.GetInstance(instance, true);
					continue;
				}
				if (instance.TagNo == 1)
				{
					reverse = X509CertificateStructure.GetInstance(instance, true);
					continue;
				}
