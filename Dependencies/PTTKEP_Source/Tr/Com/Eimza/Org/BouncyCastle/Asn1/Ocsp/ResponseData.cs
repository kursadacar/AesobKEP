...
{
	internal class ResponseData : Asn1Encodable
	{
		...
		public int ResponderIDType
		{
			get
			{
				return responderID.ResponderIDType;
			}
		}

		public string ResponderIdByName
		{
			get
			{
				return responderID.Name.StringValue;
			}
		}

		public byte[] ResponderIdByKey
		{
			get
			{
				return responderID.ID.GetOctets();
			}
		}
