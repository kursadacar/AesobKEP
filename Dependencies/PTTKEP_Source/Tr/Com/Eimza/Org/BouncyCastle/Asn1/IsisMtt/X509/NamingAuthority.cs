...
{
	internal class NamingAuthority : Asn1Encodable
	{
		...
		{
			DerObjectIdentifier idIsisMttATNamingAuthorities = IsisMttObjectIdentifiers.IdIsisMttATNamingAuthorities;
			IdIsisMttATNamingAuthoritiesRechtWirtschaftSteuern = new DerObjectIdentifier(((idIsisMttATNamingAuthorities != null) ? idIsisMttATNamingAuthorities.ToString() : null) + ".1");
		}
	}
}
