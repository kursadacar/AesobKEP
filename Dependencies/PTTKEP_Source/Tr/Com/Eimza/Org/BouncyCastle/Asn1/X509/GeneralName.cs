...
{
    internal class GeneralName : Asn1Encodable, IAsn1Choice
	{
		...
		public string StringValue
		{
			get
			{
				...
				case 2:
					...
					break;
				case 3:
					stringBuilder.Append("X400Address");
					stringBuilder.Append(" : ");
					stringBuilder.Append(obj.ToString());
					break;
				case 4:
				...
				case 5:
					...
					break;
				case 6:
					stringBuilder.Append("UniformResourceIdentifier");
					stringBuilder.Append(" : ");
					stringBuilder.Append(DerIA5String.GetInstance(obj).GetString());
					break;
				case 7:
					...
					break;
				case 8:
					stringBuilder.Append("RegisteredID");
					stringBuilder.Append(" : ");
					stringBuilder.Append(obj.ToString());
					break;
				}
		...
		public X509Name GetDirectoryName()
		{
			if (TagNo == 5)
			{
				return X509Name.GetInstance(obj);
			}
			return null;
		}
		...
		{
			if (Tr.Com.Eimza.Org.BouncyCastle.Utilities.Net.IPAddress.IsValidIPv6WithNetmask(ip) || Tr.Com.Eimza.Org.BouncyCastle.Utilities.Net.IPAddress.IsValidIPv6(ip))
			{
				int num = ip.IndexOf('/');
				if (num < 0)
				{
			...
			if (Tr.Com.Eimza.Org.BouncyCastle.Utilities.Net.IPAddress.IsValidIPv4WithNetmask(ip) || Tr.Com.Eimza.Org.BouncyCastle.Utilities.Net.IPAddress.IsValidIPv4(ip))
			{
				int num2 = ip.IndexOf('/');
				if (num2 < 0)
				{
