...
using Tr.Com.Eimza.Org.BouncyCastle.Crypto.Paddings;
...
namespace Tr.Com.Eimza.Org.BouncyCastle.Security
{
	internal static class CipherUtilities
	{
		...
		static CipherUtilities()
		{
			...
			((CipherAlgorithm)(object)Enums.GetArbitraryValue(typeof(CipherAlgorithm))).ToString();
			((CipherMode)(object)Enums.GetArbitraryValue(typeof(CipherMode))).ToString();
			((CipherPadding)(object)Enums.GetArbitraryValue(typeof(CipherPadding))).ToString();
