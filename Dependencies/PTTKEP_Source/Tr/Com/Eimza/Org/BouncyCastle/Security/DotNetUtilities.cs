...
{
    internal sealed class DotNetUtilities
	{
		...
		public static System.Security.Cryptography.X509Certificates.X509Certificate ToX509Certificate(Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate x509Cert)
		{
			return new System.Security.Cryptography.X509Certificates.X509Certificate(x509Cert.GetEncoded());
		}

		public static X509Certificate2 ToX509Certificate2(Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate x509Cert)
		{
			return new X509Certificate2(x509Cert.GetEncoded());
		}

		public static Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate FromX509Certificate(System.Security.Cryptography.X509Certificates.X509Certificate x509Cert)
		{
			return new Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate(x509Cert.GetRawCertData());
		}

		public static Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate FromX509Certificate(X509Certificate2 x509Cert)
		{
			return new Tr.Com.Eimza.Org.BouncyCastle.X509.X509Certificate(x509Cert.GetRawCertData());
		}
