...
using Tr.Com.Eimza.Org.BouncyCastle.Asn1.Iana;
...
namespace Tr.Com.Eimza.Org.BouncyCastle.Security
{
	internal static class GeneratorUtilities
	{
		...
		static GeneratorUtilities()
		{
			...
			AddDefaultKeySizeEntries(192, "AES", "AES192", "CAMELLIA192", "DESEDE3", "HMACTIGER", "RIJNDAEL", "SERPENT");
			AddDefaultKeySizeEntries(224, "HMACSHA224");
			AddDefaultKeySizeEntries(256, "AES256", "CAMELLIA", "CAMELLIA256", "CAST6", "GOST28147", "HC256", "HMACSHA256", "RC5-64", "RC6", "TWOFISH");
